...
\hyphenation{Al-go-rit-ma pe-san kom-pre-si di-gu-na-kan seg-men di-rep-re-sen-ta-si-kan di-kem-bang-kan di-sem-bu-nyi-kan eks-trak-si meng-gu-na-kan bi-lang-an pe-ri-o-de}
...
\begin{abstractind}
	...
	\bigskip
	\noindent
	\textbf{Kata kunci :} Steganografi, LSB, pesan.
\end{abstractind}
...
\begin{abstracteng}
	...
	\bigskip
	\noindent
	\textbf{\emph{Keywords :}} \emph{Steganography, LSB, message}.
\end{abstracteng}
%-----------------------------------------------------------------
